...
(4, '2024_07_26_082337_create_products_table', 1),
(5, '2024_07_26_082349_create_carts_table', 1),
(6, '2024_07_26_082356_create_orders_table', 1),
(7, '2024_07_26_082407_create_order_items_table', 1),
(8, '2024_07_27_094034_create_customer_details_table', 1),
(9, '2024_07_27_133416_add_snap_token_to_orders_table', 1);
...
ALTER TABLE `customer_details`
  ADD PRIMARY KEY (`id`),
  ADD KEY `customer_details_order_id_foreign` (`order_id`);
...
--
ALTER TABLE `customer_details`
  ADD CONSTRAINT `customer_details_order_id_foreign` FOREIGN KEY (`order_id`) REFERENCES `orders` (`id`) ON DELETE CASCADE;
